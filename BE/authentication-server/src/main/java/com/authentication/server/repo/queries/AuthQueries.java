...
public class AuthQueries {
	...
	public static final String FIND_BY_USER_NAME = "SELECT user_id, user_name, name, email, \"password\", mobile, roles "
	...
	public static final String GET_USER_BY_REFRESH_TOKEN = "SELECT u.user_id, u.user_name, u.name, u.email, u.password, u.mobile, u.roles, r.revoked, r.id, r.refresh_token "
